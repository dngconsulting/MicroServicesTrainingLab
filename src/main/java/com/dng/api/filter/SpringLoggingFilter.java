package com.dng.api.filter;

import com.dng.api.util.SpringRequestWrapper;
import com.dng.api.util.SpringResponseWrapper;
import com.dng.api.util.UniqueIDGenerator;
...
public class SpringLoggingFilter extends OncePerRequestFilter {
    ...
    @Value("${spring.logging.ignorePatterns:true}")
